...
export class SlidebarNavigationComponent {
  ...
  tabs = [
    ...
    { number: 5, property: new FormControl(SliderNavigationTabType.VARIANT3), icon: IconType.LEFT_FROM_BRACKET_LIGHT, activeIcon: IconType.LIST_SOLID, text: SliderNavigationTabTextType.LOGOUT },
  ];
