...
import { AutoClusterTabType, BadgeType, BasicTableRowPropertyVariants, ButtonIcon, ButtonIconProperty, ButtonSize, NarrowBasicTableRowInputState, NativeOptionState, NativeOptionType, SliderNavigationTabTextType, StatusActiveOrNotActive, ToastNotificationIcons } from 'src/app/enums/basic-enum';
import {  CheckStateType, IconButtonLargeType, SliderNavigationTabType, State, ButtonType, DataCellType, HeaderCellType } from 'src/app/enums/basic-enum';
