...
export class ClusterService {
  ...
  dispalayFieldsToCreateClusterForm(
    ...
    // this.checkDuplicateValues(valuesToDisplayedFields['firstName'],bookIdDetails.firstName)?valuesToDisplayedFields['firstName'].push({
    //   key: bookIdDetails.firstName.code,
    //   value: bookIdDetails.firstName.value,
    // }):null;
    // valuesToDisplayedFields['lastName'].push({
    //   key: bookIdDetails.lastName.code,
    //   value: bookIdDetails.lastName.value,
    // });
    // valuesToDisplayedFields['fatherFirstName'].push({
    //   key: bookIdDetails.fatherFirstName.code,
    //   value: bookIdDetails.fatherFirstName.value,
    // });
    // valuesToDisplayedFields['motherFirstName'].push({
    //   key: bookIdDetails.motherFirstName.code,
    //   value: bookIdDetails.motherFirstName.value,
    // });
    // valuesToDisplayedFields['spouseFirstName'].push({
    //   key: bookIdDetails.spouseFirstName.code,
    //   value: bookIdDetails.spouseFirstName.value,
    // });
    // valuesToDisplayedFields['dateOfBirth'].push({
    //   key: bookIdDetails.dateOfBirth.code,
    //   value: bookIdDetails.dateOfBirth.value,
    // });
    // valuesToDisplayedFields['placeOfBirth'].push({
    //   key: bookIdDetails.placeOfBirth.code,
    //   value: bookIdDetails.placeOfBirth.value,
    // });
    // valuesToDisplayedFields['permanentPlace'].push({
    //   key: bookIdDetails.permanentPlace.code,
    //   value: bookIdDetails.permanentPlace.value,
    // });
    // valuesToDisplayedFields['source'].push({
    //   key: bookIdDetails.source.code,
    //   value: bookIdDetails.source.value,
    // });
    // valuesToDisplayedFields['placeOfDeath'].push({
    //   key: bookIdDetails.placeOfDeath.code,
    //   value: bookIdDetails.placeOfDeath.value,
    // });
    // valuesToDisplayedFields['authenticDateOfBirth'].push({
    //   key: bookIdDetails.authenticDateOfBirth.code,
    //   value: bookIdDetails.authenticDateOfBirth.value,
    // });
    // valuesToDisplayedFields['restoredDateOfBirth'].push({
    //   key: bookIdDetails.restoredDateOfBirth.code,
    //   value: bookIdDetails.restoredDateOfBirth.value,
    // });
    // valuesToDisplayedFields['authenticDateOfDeath'].push({
    //   key: bookIdDetails.authenticDateOfDeath.code,
    //   value: bookIdDetails.authenticDateOfDeath.value,
    // });
    // valuesToDisplayedFields['restoredDateOfDeath'].push({
    //   key: bookIdDetails.restoredDateOfDeath.code,
    //   value: bookIdDetails.restoredDateOfDeath.value,
    // });
    // valuesToDisplayedFields['restoredDateOfDeath'].push({
    //   key: bookIdDetails.restoredDateOfDeath.code,
    //   value: bookIdDetails.restoredDateOfDeath.value,
    // });
    // valuesToDisplayedFields['gender'].push({
    //   key: bookIdDetails.restoredDateOfDeath.code,
    //   value: bookIdDetails.restoredDateOfDeath.value,
    // });
    // valuesToDisplayedFields['fate'].push({
    //   key: bookIdDetails.restoredDateOfDeath.code,
    //   value: bookIdDetails.restoredDateOfDeath.value,
    // });
