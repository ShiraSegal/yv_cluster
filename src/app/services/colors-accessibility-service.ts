...
export class ColorsAccessibilityService {
    ...
    setColors() {
        ...
        this.document.documentElement.style.setProperty("--sage_gray", "#C4C7C5");
        ...
        this.document.documentElement.style.setProperty("--main_primery_main", "#006AE5");
        this.document.documentElement.style.setProperty("--light_gray", "#ccc");
        this.document.documentElement.style.setProperty("--pastel_blue", "#E7EBF8");
        ...
        this.document.documentElement.style.setProperty("--deep_black", "#040405");
        this.document.documentElement.style.setProperty("--vibrant_green", "#0C803E");
        this.document.documentElement.style.setProperty("--medium_gray", "#797979");
